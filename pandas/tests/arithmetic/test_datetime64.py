...
def test_sum_empty_df_series():
    # Calling the following defined sum function returned an error for dataframes but returned NaT for series.
    # Check that the API is consistent in this sense when operating on empty Series/DataFrames.
    # See GH:33704 for more information
